...
function sig(
  ...
  return {
    id: `sig-${++_sigId}`,
    contactLinkedinUrl: contactUrl,
    contactName, contactTitle, orgId,
    engagementType: type,
    commentText: comment ?? null,
    detectedAt: daysAgo(days),
    postUrl: null,
  };
}
...
const CONTACTS: ContactDef[] = [
  // Hot (3 domains)
  { url: 'linkedin.com/in/marie-janssens', first: 'Marie', last: 'Janssens', title: 'Partner', company: 'Mercier Vanderlinden', location: 'Antwerpen', source: 'auto', enriched: true, email: 'marie.janssens@merciervanderlinden.be', phone: '+32 478 12 34 56', lemlistId: 'camp-1', lemlistPushedDaysAgo: 3, notes: 'Top lead — actief in alle 3 domeinen' },
  { url: 'linkedin.com/in/philippe-van-damme', first: 'Philippe', last: 'Van Damme', title: 'Managing Director', company: 'Sofina', location: 'Brussel', source: 'auto', enriched: true, email: 'pvandamme@sofina.be' },
  { url: 'linkedin.com/in/nathalie-wouters', first: 'Nathalie', last: 'Wouters', title: 'Director', company: 'Wouters Family Office', location: 'Gent', source: 'auto', enriched: true, email: 'n.wouters@woutersfo.be', phone: '+32 499 88 77 66' },
  // Warm (2 domains)
  { url: 'linkedin.com/in/thomas-de-smedt', first: 'Thomas', last: 'De Smedt', title: 'CEO', company: 'De Smedt Capital', location: 'Gent', source: 'auto', enriched: true, email: 'thomas@desmedtcapital.be', lemlistId: 'camp-1', lemlistPushedDaysAgo: 10, lastContactedDaysAgo: 10, notes: 'Follow-up nodig — al 10 dagen geen reactie' },
  { url: 'linkedin.com/in/sophie-claes', first: 'Sophie', last: 'Claes', title: 'CFO', company: 'Claes & Partners', location: 'Brussel', source: 'auto', notes: 'Stijgende activiteit — in de gaten houden' },
  { url: 'linkedin.com/in/jan-peeters', first: 'Jan', last: 'Peeters', title: 'Wealth Manager', company: 'Puilaetco', location: 'Brussel', source: 'auto' },
  { url: 'linkedin.com/in/charlotte-dubois', first: 'Charlotte', last: 'Dubois', title: 'Partner', company: 'Dubois Family Office', location: 'Brussel', source: 'auto', enriched: true, email: 'c.dubois@duboisfo.be' },
  { url: 'linkedin.com/in/pieter-vdberg', first: 'Pieter', last: 'Van den Berg', title: 'Director', company: 'Ackermans & van Haaren', location: 'Antwerpen', source: 'auto' },
...
const SIGNAL_PATTERNS: { contactIdx: number; orgId: string; days: number; type: 'like' | 'comment'; comment?: string }[] = [
  ...
  // Philippe (1) — 3 domains, 8 signals
  ...
  // Nathalie (2) — 3 domains, 7 signals
  ...
  // Thomas (3) — kunst + beleggen, 6 signals
  ...
  // Sophie (4) — beleggen + luxe, 5 signals (recent = rising)
  ...
  // Jan (5) — kunst + beleggen, 4 signals
  ...
  // Charlotte (6) — kunst + luxe, 4 signals
  ...
  // Pieter (7) — beleggen + luxe, 3 signals
